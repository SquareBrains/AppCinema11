...
data class Film(
    ...
    val filmsDataBase = listOf(
        Film("Back in Future", R.drawable.back, "Teenager Marty, with the " +
        ...
        Film("Coco",R.drawable.coco,"12 year old Miguel lives in a Mexican village in a family of shoemakers and secretly dreams of becoming a musician. Secretly, because music is considered a curse in his family. Once his great-great-grandfather left his wife, Miguel's great-great-grandmother, for the sake of a dream that now does not allow his " +
                "great-great-grandson to live in peace. Since then, the musical theme in the family has become a taboo"),
        Film("Fight Club",R.drawable.fight,"An insurance company employee suffers from chronic insomnia and is desperately trying to escape from a painfully boring life. One day, on a regular business trip, he meets a certain Tyler Durden," +
        ...
        Film("Forrest Gump",R.drawable.forrest,"\n" +
        ...
        Film("Green Mile", R.drawable.mile,"Paul Edgecomb is the head of the death row at Cold Mountain Prison, each of whose prisoners once walks the" +
        ...
        Film("Inter",R.drawable.inter, "When drought, dust storms, and plant extinction lead humanity into a food crisis, " +
        ...
        Film ("Lord of Rings", R.drawable.lordof,"Sauron, the lord of the forces of darkness, sends his countless army under the walls of Minas Tirith, the fortress of Light's Hope. He looks forward to a close victory, but this is what prevents him from noticing two tiny figures - hobbits approaching Mount Doom, " +
                "where they have to destroy the Ring of Omnipotence."),
        Film("The Shawshank Redemption",R.drawable.show,"Accountant Andy Dufresne is accused of killing his wife and her lover. Once in a prison called Shawshank, he is faced with cruelty and lawlessness that reigns on both sides of the bars. Everyone who enters these walls becomes their slave for the rest of their lives. But Andy, who has a lively mind and a kind soul, " +
